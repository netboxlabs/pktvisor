...
class NetProbeHandlerModulePlugin : public HandlerModulePlugin
{
...
public:
   explicit NetProbeHandlerModulePlugin(Corrade::PluginManager::AbstractManager &manager, const Corrade::Containers::StringView plugin)
